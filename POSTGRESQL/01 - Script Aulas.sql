...
COPY MAQUINAS
FROM 'C:\SOFTWARES\LogMaquinas.csv' 
DELIMITER ','
CSV HEADER;
...
/* GERANDO ARQUIVO CSV DA TABELA*/
COPY REL_LOCADORA TO
'C:\SOFTWARES\REL_LOCADORA.csv'
DELIMITER ';'
CSV HEADER;
...
/* O COMANDO ABAIXO É PRA BUSCAR O ID DE SEQUENCE CORRETO */
NEXTVAL('SEQ_LOCACAO');
...
'C:\SOFTWARES\RELATORIO_LOCADORA.csv'
DELIMITER ';'
CSV HEADER;
...
INSERT INTO LOCACAO VALUES(NEXTVAL('SEQ_LOCACAO'),NOW(),90,12,200);
